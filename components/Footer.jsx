  ...
  <div className="max-w-6xl mx-auto px-6 md:px-16 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
    ...
    <div>
      ...
      <div className="flex items-center gap-3 mt-5">
        <a
          href="https://instagram.com/wallnutflow" // replace with your real link
          target="_blank"
          rel="noreferrer"
        ...
        <a
          href="https://linkedin.com/company/wallnutflow" // replace with your real link
          target="_blank"
          rel="noreferrer"
    ...
    <div>
      ...
      <ul className="space-y-2 text-sm text-gray-600">
        <li>📧 support@wallnutflow.com</li>
        <li>🌍 <a href="https://wallnutflow.com" className="hover:text-orange-600 transition">www.wallnutflow.com</a></li>
        <li>📍 India</li>
      </ul>
    </div>
  </div>
